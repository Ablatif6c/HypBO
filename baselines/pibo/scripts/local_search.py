...
try:
    from hypermapper.local_search import main
...
if __name__ == "__main__":
    warnings.warn(
        "Using 'scripts/local_search' is deprecated and it will be removed in the future. "
        "Use 'hypermapper/local_search' instead.",
        DeprecationWarning,
        2,
    )
