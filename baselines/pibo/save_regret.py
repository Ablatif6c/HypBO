"""
This script generates and saves regret data and cumulative regret data for a given list of function names and scenario names.

The script takes a list of function names, a list of scenario names, a directory name to save the data, and the number of data points to consider as input.
It generates regret data and cumulative regret data for each function and saves them as CSV files.
