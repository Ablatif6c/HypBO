...
class Turbo1:
    ...
    def __init__(
        ...
        self.failtol = np.ceil(
            np.max([4.0 / batch_size, self.dim / batch_size]))
        self.succtol = 3
        self.n_evals = 0
    ...
    def _create_candidates(self, X, fX, length, n_training_steps, hypers, seed: int = 1e6):
        ...
        pert = sobol.draw(self.n_cand).to(
    ...
    def optimize(self):
        ...
        while self.n_evals < self.max_evals:
            ...
            X_init = latin_hypercube(self.n_init, self.dim, seed=self.seed)
